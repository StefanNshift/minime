...
$(function() {
 ...
 Nshift.global = {
  ...
  init: function() {
   Nshift.global.deviceSize();
   Nshift.global.layout();
   Nshift.global.animsition();
  },
 ...
 Nshift.navbar = {
  ...
  init: function() {
   Nshift.navbar.menu();
   Nshift.navbar.ripple();
   Nshift.navbar.removeRipple();
   Nshift.navbar.collapse();
   Nshift.navbar.offcanvas();
  },
 ...
 Nshift.boxss = {
  ...
  init: function() {
   Nshift.boxss.toggle();
   Nshift.boxss.refresh();
   Nshift.boxss.fullscreen();
   Nshift.boxss.close();
  },
 ...
 Nshift.extra = {
  ...
  init: function() {
   Nshift.extra.sparklineChart();
   Nshift.extra.slimScroll();
   Nshift.extra.daterangePicker();
   Nshift.extra.easypiechart();
   
   Nshift.extra.toggleClass();
   Nshift.extra.colorpicker();
   Nshift.extra.touchspin();
   Nshift.extra.datepicker();
   Nshift.extra.animateProgress();
   Nshift.extra.counter();
   Nshift.extra.popover();
   Nshift.extra.tooltip();
   Nshift.extra.splash();
   Nshift.extra.lightbox();
  },
 ...
 Nshift.isMobile = {
  ...
  any: function() {
   return (Nshift.isMobile.Android() || Nshift.isMobile.BlackBerry() || Nshift.isMobile.iOS() || Nshift.isMobile.Opera() || Nshift.isMobile.Windows());
  }
 };
 // initialize after resize
 Nshift.documentOnResize = {
  init: function() {
   var t = setTimeout(function() {
    Nshift.documentOnReady.setSidebar();
    Nshift.navbar.removeRipple();
   }, 500);
  }
 };
 // initialize when document ready
 Nshift.documentOnReady = {
  init: function() {
   Nshift.global.init();
   Nshift.header.init();
   Nshift.navbar.init();
   Nshift.documentOnReady.windowscroll();
   Nshift.boxss.init();
   Nshift.extra.init();
   Nshift.documentOnReady.setSidebar();
  },
 ...
 // initializing
 $(document).ready(Nshift.documentOnReady.init);
 $window.on('resize', Nshift.documentOnResize.init);
