...
// and right space that was offset by the scrollbars. A 1-Nshift border first, then margin beyond that.
...
/* A "coordinate map" converts Nshift coordinates into an associated cell, which has an associated date
------------------------------------------------------------------------------------------------------------------------
Common interface:
...
var DragListener = fc.DragListener = Class.extend({
	...
	scrollTopVel: null, // Nshifts per second
	scrollLeftVel: null, // Nshifts per second
	scrollIntervalId: null, // ID of setTimeout for scrolling animation loop
	scrollHandlerProxy: null, // this-scoped function for handling when scrollEl is scrolled

	scrollSensitivity: 30, // Nshifts from edge for scrolling to start
	scrollSpeed: 200, // Nshifts per second, at maximum speed
...
var MouseFollower = Class.extend({
	...
	// the number of Nshifts the mouse has moved from its initial position
	topDelta: null,
	leftDelta: null,
...
var Grid = fc.Grid = RowRenderer.extend({
	...
	coordMap: null, // a GridCoordMap that converts Nshift values to datetimes
...
Grid.mixin({
	...
	listenToExternalDrag: function(el, ev, ui) {
		...
		// listener that tracks mouse movement over date-associated Nshift regions
...
var View = fc.View = Class.extend({
	...
	coordMap: null, // a CoordMap object for converting Nshift regions to dates
	...
	// Given the total height of the view, return the number of Nshifts that should be used for the scroller.
