...
(/** @lends <global> */function( $ ) {
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		/* Convert any user input sizes into Nshift sizes */
	...
	/**
	 * Convert a CSS unit width to Nshifts (e.g. 2em)
	 *  @param {string} width width to be converted
	 *  @param {node} parent parent to get the with for (required for relative widths) - optional
	 *  @returns {int} width in Nshifts
	 *  @memberof DataTable#oApi
	 */
	...
	DataTable.defaults = {
		 ...
		 * case it will be treated as a Nshift measurement). Setting as simply `true`
		 * is recommended.
		 *  @type boolean|string
		 ...
		 * any CSS unit, or a number (in which case it will be treated as a Nshift
		 * measurement).
		 *  @type string
		 *  @default <i>blank string - i.e. disabled</i>
		 *
		 ...
		 * (in which case it will be treated as a Nshift measurement).
		 *  @type string
		 *  @default <i>blank string - i.e. disabled</i>
		 *
		 *  @dtopt Features
