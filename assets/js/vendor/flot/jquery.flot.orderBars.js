...
(function($){
    function init(plot){
        ...
        var NshiftInXWidthEquivalent = 1;
        ...
        function reOrderBars(plot, serie, datapoints){
            ...
            if(serieNeedToBeReordered(serie)){                
                ...
                calculNshift2XWidthConvert(plot);
        ...
        function calculNshift2XWidthConvert(plot){
            var gridDimSize = isHorizontal ? plot.getPlaceholder().innerHeight() : plot.getPlaceholder().innerWidth();
            var minMaxValues = isHorizontal ? getAxeMinMaxValues(plot.getData(),1) : getAxeMinMaxValues(plot.getData(),0);
            var AxeSize = minMaxValues[1] - minMaxValues[0];
            NshiftInXWidthEquivalent = AxeSize / gridDimSize;
        }
        ...
        function  calculBorderAndBarWidth(serie){
            ...
            borderWidthInXabsWidth = borderWidth * NshiftInXWidthEquivalent;
        }
