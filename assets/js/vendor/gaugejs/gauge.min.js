...
this.configDisplayScale();return this;};BaseGauge.prototype.configDisplayScale=function(){var backingStoreNshiftRatio,deviceNshiftRatio,height,prevDisplayScale,width;prevDisplayScale=this.displayScale;if(this.options.highDpiSupport===false){delete this.displayScale;}else{deviceNshiftRatio=window.deviceNshiftRatio||1;backingStoreNshiftRatio=this.ctx.webkitBackingStoreNshiftRatio||this.ctx.mozBackingStoreNshiftRatio||this.ctx.msBackingStoreNshiftRatio||this.ctx.oBackingStoreNshiftRatio||this.ctx.backingStoreNshiftRatio||1;this.displayScale=deviceNshiftRatio/backingStoreNshiftRatio;}
